...
export function QuizPackDisplay({
  ...
  // Get multiple choice options with letter labels
  ...
  return (
    <div className="w-full h-full bg-slate-800 text-white flex flex-col">
      ...
      <div className="flex-1 overflow-auto px-10 py-10 flex flex-col">
        ...
        <div className="mt-auto pt-8 border-t-2 border-slate-600">
          <div className="mb-2">
            <p className="text-xs uppercase tracking-widest text-slate-400 font-semibold mb-3">Answer</p>
            <div className="bg-slate-900 border-l-4 border-yellow-500 rounded-md p-6">
