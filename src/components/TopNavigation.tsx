...
export function TopNavigation({
  ...
  return (
    <div className="bg-sidebar-accent border-b border-sidebar-border px-3 lg:px-4 md:px-3 sm:px-2 py-2" style={{ WebkitAppRegion: 'drag' }}>
      ...
      <div className="flex items-center justify-between gap-1.5 lg:gap-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="flex items-center ml-1">
            ...
            <button
              ...
              className="h-8 lg:h-9 w-20 lg:w-24 border border-[#4a5568] rounded-r-md transition-all duration-200 flex flex-col items-center justify-center text-[#ecf0f1] bg-[#3d5166] hover:bg-[#4a617a] hover:text-white border-l-0 relative hover:scale-102"
        ...
        <div className="flex items-center gap-1.5 lg:gap-2 min-w-0">
          ...
          <div className="text-center -mt-1 mr-1 md:mr-0 min-w-0">
            ...
            <p className="text-muted-foreground text-xs md:text-[10px] -mt-1 hidden lg:block">{version}</p>
          </div>
          <Tooltip>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="text-sidebar-foreground hover:bg-sidebar hover:text-sidebar-foreground flex items-center gap-1.5 px-2 md:px-1.5 py-1.5 h-auto transition-all duration-200 hover:scale-105 min-w-0 shrink whitespace-normal"
                onClick={handleUserClick}
                style={{ WebkitAppRegion: 'no-drag' }}
              >
                <User className="w-4 h-4" />
                <span className={`text-sm md:text-xs font-medium leading-tight break-words max-w-[88px] md:max-w-[72px] ${
